...
fun Calculator(
    ...
    Box(modifier = modifier) {
        Column(
            ...
            verticalArrangement = Arrangement.spacedBy(buttonSpaccing)
        ) {
            Text(
            ...
            Row(
                ...
                horizontalArrangement = Arrangement.spacedBy(buttonSpaccing)
            ) {
            ...
            Row(
                ...
                CalculatorButton(
                    ...
                    modifier = Modifier
                        ...
                        .weight(1f),
                    onClick = {
                        onAction(CalculatorAction.Operation(CalculatorOperator.Subtract))
                    }
                )
